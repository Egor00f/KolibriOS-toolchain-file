...
#Set linker flags
set(CMAKE_C_LINKER_FLAGS "-nostdlib -static -S --image-base 0 -T ${NewLib_DIR}/app.lds -L${TOOLCHAIN_PATH}/lib -L${TOOLCHAIN_PATH}/mingw32/lib -L${SDK_DIR}/lib --subsystem native" CACHE STRING "KOLIBRIOS C LINKER FLAGS")
set(CMAKE_CXX_LINKER_FLAGS ${CMAKE_C_LINKER_FLAGS} CACHE STRING "KOLIBRIOS CXX LINKER FLAGS")


set(CMAKE_C_LINK_EXECUTABLE   "<CMAKE_LINKER> <LINK_FLAGS> --start-group -lgcc -lc.dll <LINK_LIBRARIES> --end-group -o <TARGET> <OBJECTS>  <CMAKE_C_LINK_FLAGS>" CACHE STRING "KOLIBRIOS C LINK EXECUTABLE")
set(CMAKE_CXX_LINK_EXECUTABLE "<CMAKE_LINKER> <LINK_FLAGS> --start-group -lgcc -lc.dll -lstdc++ -lsupc++ <LINK_LIBRARIES> --end-group -o <TARGET> <OBJECTS> <CMAKE_CXX_LINK_FLAGS>" CACHE STRING "KOLIBRIOS CXX LINK EXECUTABLE")
